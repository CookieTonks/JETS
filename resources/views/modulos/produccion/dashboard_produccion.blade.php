        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{route('exportar_produccion')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Reporte General</a>
                    
                </div>
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"> </h1>
                    <a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#reporte_tecnico">Reporte Tecnico </a>
                ...
                <div class="modal fade" id="reporte_tecnico" tabindex="-1" role="dialog" aria-labelledby="exampleModalForms" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Reporte: Trabajo por tecnico</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form action="{{ route('exportar_tecnicos') }}" method="post">
                                    @csrf
                                    ...
                                    <br>
                                    <button type="submit" class="btn btn-block btn-primary">Descargar</button>
                                </form>
                            </div>
                        </div>
                    </div>
